;(function (factory) {
    ...
    SimpleBar.prototype.init = function () {
        ...
        if (this.options.autoHide) {
            ...
            //LRC
            window.setTimeout($.proxy(this.flashScrollbar, this), 500);
    ...
    SimpleBar.prototype.resizeScrollContent = function () {
        ...
        if (this.scrollDirection === 'vert'){
            //LRCthis.$scrollContentEl.width(this.$el.width()+SCROLLBAR_WIDTH);
            //LRCthis.$scrollContentEl.height(this.$el.height());
        } else {
